...
export default function ReviewerRegulationsList() {
  ...
  const actionFor = (r) => {
    ...
    if (r.statusBucket === "in_revision") return { label: "View Progress", href: `/reviewer/regulations/${r.id}` };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <Chip active={bucketFilter === "in_revision"} onClick={() => setBucketFilter("in_revision")}>
          In Revision ({counts.in_revision})
        </Chip>
